...
# ========================================================
# 1. PARAMETER DEFAULT (Sesuai Referensi Anda)
# ========================================================
A_SHIFT = 0
B_SHIFT = 0
OMEGA = 0.75
...
# ========================================================
# 2. FUNGSI PREPROCESSING (PIPELINE ANDA)
# ========================================================
...
def white_balance_adaptive(img, cast_thresh=5.0, cast_max=30.0):
    ...
    return cv2.cvtColor(cv2.merge([L, A_corr, B_corr]), cv2.COLOR_LAB2BGR)
...
def enhance_underwater_pipeline(img):
    out = white_balance_adaptive(img) # [wb'']
...
# ========================================================
# 4. MAIN PROCESSOR (FOLDER PATHS)
# ========================================================

input_folder = "/home/krbai/coba_yolo_auv/gambar_testing_mentah/"
output_folder = "/home/krbai/coba_yolo_auv/output/output_preprocess_final/"
os.makedirs(output_folder, exist_ok=True)

image_files = [f for f in os.listdir(input_folder) if f.lower().endswith(('.jpg', '.jpeg', '.png'))]

print(f"🚀 Memulai Preprocessing pada {len(image_files)} gambar di Jetson...")
print("-" * 50)
...
for fname in sorted(image_files):
    ...
    # JALANKAN PIPELINE
    enhanced_img = enhance_underwater_pipeline(img)
    ...
    print(f"[INFO] {fname} | Time: {(end_time - start_time)*1000:.1f} ms")

total_end = time.time()
print("-" * 50)
print(f"✅ Selesai! Total waktu: {total_end - total_start:.2f} detik")
