...
#ifndef GB_LIB_INCLUDE_GB_LIB_GB_NAVIGATION_NAV_UTILS_H_
#define GB_LIB_INCLUDE_GB_LIB_GB_NAVIGATION_NAV_UTILS_H_
...
Eigen::Vector3d quaternion2Euler(const double x, const double y, const double z, const double w);
